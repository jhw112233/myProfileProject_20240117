			...
			<td class="con_box" align="center">
				...
				<input type="hidden" value="${boardDto.qbnum }" name="qbnum">
					<tr>
						...
						<td><input class="input_box01" style="background-color:#D5D5D5;" type="text" name="qbmid" value="${boardDto.qbmid}" readonly="readonly"></td>
					</tr>					
					<tr>
						<td class="con_text">이 름 :</td>
						<td><input class="input_box01" style="background-color:#D5D5D5;" type="text" name="qbmname" value="${boardDto.qbmname }" readonly="readonly"></td>
					</tr>					
					<tr>
						<td class="con_text">이 메 일 :</td>
						<td><input class="input_box01"  style="background-color:#D5D5D5;" type="text" name="qbmemail" value="${boardDto.qbmemail }" readonly="readonly"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input class="input_box01"  style="background-color:#D5D5D5;" type="text" name="qbdate" value="${boardDto.qbdate }" readonly="readonly"></td>
						</td>
					</tr>					
					<tr>
						<td colspan="2">&nbsp;</td>
